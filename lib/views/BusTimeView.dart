    ...
    return BlocConsumer<GetDataCubit, GetDataState>(
      listener: (context, state) {
        if (state is SuccessGet) {
          // You can stop loading here if required
        } else if (state is SuccessGetBuses) {
          searchDefault = false;
          setState(() {
            buses = state.buses; // Get the list of buses from the state
            timeTableVisible = buses.isNotEmpty; // Show timetable if there are buses
          });
      ...
      builder: (context, state) {
        ...
        final stations = context.read<GetDataCubit>().stationDetails.map((station) => station.stationName).toList();

        return ModalProgressHUD(
          inAsyncCall: state is GetDataInitial, // Show loader while data is loading
          color: Colors.red,
          child: Scaffold(
                      ...
                      Visibility(
                        ...
                        child: SizedBox(
                          ...
                          child: ListView.builder(
                            itemCount: buses.length, // Use the actual number of buses
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: DropdownButton<String>(
                                  isExpanded: true,
                                  iconSize: 38,
                                  iconEnabledColor: Color(0xffFFD1D1D1),
                          ...
                          // Time Dropdown
                          // Time dropdown can be omitted since the bus times are now fetched directly with the bus information
                        ],
                      ),
                    ),
                  ),
